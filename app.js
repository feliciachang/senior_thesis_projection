// WebGL - Planar Projection with lines
// from https://webglfundamentals.org/webgl/webgl-planar-projection-with-projection-matrix.html
...
function main() {
  ...
  const sphereBufferInfo2 = primitives.createSphereBufferInfo(
    gl,
    1, // radius
    12, // subdivisions around
    6 // subdivisions down
  ...
  const imageTexture = loadImageTexture("http://0.0.0.0:8000/test.png");
  ...
  function drawScene(projectionMatrix, cameraMatrix) {
    ...
    webglUtils.setUniforms(textureProgramInfo, sphereUniforms2);
    webglUtils.drawBufferInfo(gl, sphereBufferInfo2);
